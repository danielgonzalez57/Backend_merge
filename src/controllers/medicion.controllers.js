...
// CREAR
async function medicionCreated(id_invest, hora, nro_visitantes, nro_facturas, user_crea, 
                                user_mod){
...
// ACTUALIZAR
async function medicionUpdate(id, id_invest, hora, nro_visitantes, nro_facturas, user_crea, 
                            user_mod){
